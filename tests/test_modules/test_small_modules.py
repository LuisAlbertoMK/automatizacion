...
from exceptions import ActaNacimientoError, PasaporteError, RFCError, SemanasError


class TestSemanasModule:
    MODULE = "modules.semanas"
...
class TestActaNacimientoModule:
    MODULE = "modules.acta_nacimiento"
