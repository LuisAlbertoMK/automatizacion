...
from exceptions import AntecedentesError, CitaINEerror, CitaSATError, ControlConfianzaError


class TestAntecedentesModule:
    MODULE = "modules.antecedentes"
    ...
    async def test_consultar_success(self):
        ...
        with (
            ...
            mod.launch_browser = AsyncMock(return_value=(MagicMock(), MagicMock(), MagicMock()))
...
class TestControlConfianzaModule:
    MODULE = "modules.control_confianza"
